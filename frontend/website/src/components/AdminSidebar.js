        ...
        >
          <ul className="nav">
            ...
            <li className="nav-item">
              <CustomLink to="/register-patient" className="nav-link">
                Register patient
              </CustomLink>
            </li>
            <li className="nav-item">
              <CustomLink to="/ManagePatientAdmin" className="nav-link">
                Manage Patients
              </CustomLink>
            </li>
            <li className="nav-item">
              <CustomLink to="/ManagePharmacistAdmin" className="nav-link">
                Manage Pharmacists
              </CustomLink>
            </li>
            <li className="nav-item">
              <CustomLink to="/ManageHealthcareProviders" className="nav-link">
                Manage Healthcare Providers
              </CustomLink>
            </li>
            <li className="nav-item">
              <CustomLink to="/ManageHealthAdmins" className="nav-link">
                Manage Health Admins
              </CustomLink>
            </li>
            <li className="nav-item">
              <CustomLink to="/DataOversight" className="nav-link">
                Data Oversight
              </CustomLink>
            </li>
            <li className="nav-item">
              <CustomLink to="/AdminDashboard" className="nav-link">
                Generate Report
              </CustomLink>
            </li>
            <li className="nav-item nav-category">
            ...
            <li className="nav-item">
              <CustomLink to="/admin-chat" className="nav-link">
